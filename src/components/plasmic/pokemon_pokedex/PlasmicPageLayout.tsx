...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: BEvG0BIpe1Q0/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: R0bD8dotzNiZ/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: HAP1ZjTJaMMq/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__dpKJ)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
        const __composite = [{ path: null, name: null }];
        __composite["0"]["path"] = `/pokedex`;
      ...
      simpleNavTheme={(() => {
        ...
        __composite["customBgColor"] = "#00120B";
        return __composite;
      })()}
      title={"Pokedex"}
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___1KFhD)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__bw9MN)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__fUzxL)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__lV6X)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
